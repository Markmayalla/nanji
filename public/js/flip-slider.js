 ...
 */
{
    ...
    class Slideshow {
        ...
        initEvents() {
            ...
            //Automatic slide play
            setInterval(arrowClickNextFn, 2000);
        }
        ...
        pagethrough(direction) {
            ...
            let newPagePos = direction === 'next' ? this.current + 1 : this.current - 1;

            if (this.current === this.slidesTotal - 1 && direction === 'next') {
                newPagePos = 0;
            }

            if (this.current === 0 && direction === 'prev') {
                newPagePos = this.slidesTotal-1;
            }
